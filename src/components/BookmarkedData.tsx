...
const BookmarkedData = () => {
  ...
  if (!loggedIn) {
    return (
      <div className="sticky top-0 z-10 p-8 bg-white text-grey-700 drop-shadow-lg">
  ...
  return (
    <div className="sticky top-0 z-10 p-8 bg-white text-grey-700 dark:text-grey-200 drop-shadow-lg">
      ...
      <div className="mt-2 flex justify-between">
        <div className="text-sm py-1 px-2 bg-grey-100 hover:bg-grey-200 rounded-md text-grey-600 hover:cursor-pointer"
