import { Empty, singleToArray, standardizeID } from "../util";
...
export type GetFCEsResBody =
  Awaited<ReturnType<typeof prisma.fces.findMany>>;

export const getFCEs: RequestHandler<Empty, GetFCEsResBody, Empty, GetFCEsQuery>
  = async (req, res, next) => {
